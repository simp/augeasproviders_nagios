%define mod_name augeasproviders_nagios

Summary: Nagios Augeas-based providers for Puppet
Name: pupmod-augeasproviders_nagios
Version: 2.0.1
Release: 0
...
%description
This module provides types/providers for nagios using the Augeas configuration API library.
